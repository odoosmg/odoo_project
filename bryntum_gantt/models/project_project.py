...
class ProjectProject(models.Model):
    ...
    project_start_date = fields.Datetime(string="Project Start Date", tracking=True,
                                         default=(datetime.now().replace(hour=0,minute=0,second=0) - timedelta(hours=7)))

    # department_id = fields.Many2many('hr.department', string='Owner')
    ...
    def get_bryntum_values(self):
        ...
        res = {
            'companyIds': self.env.companies.ids,
